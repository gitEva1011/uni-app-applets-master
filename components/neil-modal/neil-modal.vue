    ...
    <view class="neil-modal" @touchmove.stop.prevent="bindTouchmove" :class="{'neil-modal--show':isOpen}">
        ...
        <view class="neil-modal__container">
			<view class="titleBox">
				...
				<view class="close" @tap="clickLeft"><image src="../../static/images/tabbar/close.png"></image> </view>
			</view>
...
<style lang="scss">
    ...
    .neil-modal {
		...
		.titleBox{position: relative;
			.neil-modal__header{text-align:center;margin-top:10rpx;}
			.close{width: 30rpx;height:30rpx;position: absolute;right:10rpx;top:10rpx;z-index: 10;
